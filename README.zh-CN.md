...
- `3lab/`：内核模块、字符设备与系统调用表修改实验，详见 [`3lab/README.zh-CN.md`](3lab/README.zh-CN.md)。
...
```
> `p_sys_call_table` 需使用当前内核的实际地址，可通过 `/proc/kallsyms` 查询。更多细节见 [`3lab/README.zh-CN.md`](3lab/README.zh-CN.md)。
...
- Lab3 的完整步骤、问答与调试技巧见 [`3lab/README.zh-CN.md`](3lab/README.zh-CN.md)。
